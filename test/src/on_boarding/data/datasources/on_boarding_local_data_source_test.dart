...
void main() {
  ...
  group('checkIfUserIsFirstTimer', () {
    test('should call SharedPreferences to check if user is first timer '
          'and return the right response from storage when data exist', 
          () async {
    ...
    test(
      'should throw a CacheException where there is an error retrieving the data', 
      () async {
